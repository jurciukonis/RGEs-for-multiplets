...
(* ---------------------------------------------------------------------- *) 
(* File created at 18:01 on 19.6.2024  *) 
(* ---------------------------------------------------------------------- *) 
...
AllEquations = {Derivative[1][v][t] == 
 ...
 Derivative[1][g1][t] == ((41 + 4*Y^2)*g1[t]^3*Log[10])/(160*Pi^2), 
 Derivative[1][g2][t] == (-3*g2[t]^3*Log[10])/(16*Pi^2), 
 ...
 Derivative[1][Yu[1, 1]][t] == 
  ...
  (Log[10]*((27*g1[t]^4)/100 + (9*g1[t]^2*g2[t]^2)/10 + (9*g2[t]^4)/4 - 
     ...
     12*\[Kappa]1[t]^2 + 4*\[Kappa]3[t]^2 + 4*\[Kappa]3[t]*\[Kappa]4[t] + 
     2*\[Kappa]4[t]^2 + 12*\[Kappa]1[t]*(Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + 
       Yu[3, 3][t]^2) - 12*(Yu[1, 1][t]^4 + Yu[2, 2][t]^4 + Yu[3, 3][t]^4)))/
   (16*Pi^2), Derivative[1][\[Kappa]3][t] == 
  (Log[10]*((27*Y^2*g1[t]^4)/25 + (9*g2[t]^4)/4 - (9*g1[t]^2*\[Kappa]3[t])/
      10 - (18*Y^2*g1[t]^2*\[Kappa]3[t])/5 + 6*\[Kappa]1[t]*\[Kappa]3[t] + 
     6*\[Kappa]2[t]*\[Kappa]3[t] + 4*\[Kappa]3[t]^2 - 
     (9*g2[t]^2*(Y*g1[t]^2 + 5*\[Kappa]3[t]))/5 + 
     2*\[Kappa]1[t]*\[Kappa]4[t] + 2*\[Kappa]2[t]*\[Kappa]4[t] + 
     2*\[Kappa]4[t]^2 + 6*\[Kappa]3[t]*(Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + 
       Yu[3, 3][t]^2)))/(16*Pi^2), Derivative[1][\[Kappa]4][t] == 
  (Log[10]*((9*g1[t]^2*(4*Y*g2[t]^2 - (1 + 4*Y^2)*\[Kappa]4[t]))/10 + 
     \[Kappa]4[t]*(-9*g2[t]^2 + 2*(\[Kappa]1[t] + \[Kappa]2[t] + 
         4*\[Kappa]3[t] + 2*\[Kappa]4[t])) + 6*\[Kappa]4[t]*
      (Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + Yu[3, 3][t]^2)))/(16*Pi^2), 
 Derivative[1][\[Kappa]2][t] == 
  (Log[10]*((108*Y^4*g1[t]^4)/25 + (9*g2[t]^4)/4 + 
     (9*g2[t]^2*(2*Y^2*g1[t]^2 - 5*\[Kappa]2[t]))/5 - 
     (36*Y^2*g1[t]^2*\[Kappa]2[t])/5 + 
     2*(6*\[Kappa]2[t]^2 + 2*\[Kappa]3[t]^2 + 2*\[Kappa]3[t]*\[Kappa]4[t] + 
       \[Kappa]4[t]^2)))/(16*Pi^2)}
