...
(* ---------------------------------------------------------------------- *) 
(* File created at 14:44 on 1.7.2024  *) 
(* ---------------------------------------------------------------------- *) 
...
AllEquations = {Derivative[1][v][t] == 
 ...
 Derivative[1][g1][t] == ((41 + 6*Y^2)*g1[t]^3*Log[10])/(160*Pi^2), 
 Derivative[1][g2][t] == (-5*g2[t]^3*Log[10])/(32*Pi^2), 
 ...
 Derivative[1][Yu[1, 1]][t] == 
  ...
  (Log[10]*((27*g1[t]^4)/100 + (9*g1[t]^2*g2[t]^2)/10 + (9*g2[t]^4)/4 - 
     ...
     12*\[Kappa]1[t]^2 + 6*\[Kappa]3[t]^2 + 6*\[Kappa]3[t]*\[Kappa]4[t] + 
     (5*\[Kappa]4[t]^2)/2 + 12*\[Kappa]1[t]*(Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + 
       Yu[3, 3][t]^2) - 12*(Yu[1, 1][t]^4 + Yu[2, 2][t]^4 + Yu[3, 3][t]^4)))/
   (16*Pi^2), Derivative[1][\[Kappa]3][t] == 
  (Log[10]*((27*Y^2*g1[t]^4)/25 + 6*g2[t]^4 + 
     (3*g2[t]^2*(12*Y*g1[t]^2 - 55*\[Kappa]3[t]))/10 - 
     (9*g1[t]^2*\[Kappa]3[t])/10 - (18*Y^2*g1[t]^2*\[Kappa]3[t])/5 + 
     6*\[Kappa]1[t]*\[Kappa]3[t] + 8*\[Kappa]2[t]*\[Kappa]3[t] + 
     4*\[Kappa]3[t]^2 + 2*\[Kappa]1[t]*\[Kappa]4[t] + 
     3*\[Kappa]2[t]*\[Kappa]4[t] + \[Kappa]4[t]^2 + 
     12*\[Kappa]3[t]*\[Kappa]5[t] + 2*\[Kappa]4[t]*\[Kappa]5[t] + 
     6*\[Kappa]3[t]*(Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + Yu[3, 3][t]^2)))/
   (16*Pi^2), Derivative[1][\[Kappa]4][t] == 
  (Log[10]*((-33*g2[t]^2*\[Kappa]4[t])/2 - 
     (9*g1[t]^2*(8*Y*g2[t]^2 + \[Kappa]4[t] + 4*Y^2*\[Kappa]4[t]))/10 + 
     2*\[Kappa]4[t]*(\[Kappa]1[t] + \[Kappa]2[t] + 4*\[Kappa]3[t] + 
       2*\[Kappa]4[t] + 4*\[Kappa]5[t]) + 6*\[Kappa]4[t]*
      (Yu[1, 1][t]^2 + Yu[2, 2][t]^2 + Yu[3, 3][t]^2)))/(16*Pi^2), 
 Derivative[1][\[Kappa]2][t] == 
  (Log[10]*((108*Y^4*g1[t]^4)/25 + 30*g2[t]^4 - (36*Y^2*g1[t]^2*\[Kappa]2[t])/
      5 + 14*\[Kappa]2[t]^2 - (24*g2[t]^2*(3*Y^2*g1[t]^2 + 5*\[Kappa]2[t]))/
      5 + 4*\[Kappa]3[t]^2 + 4*\[Kappa]3[t]*\[Kappa]4[t] + 
     24*\[Kappa]2[t]*\[Kappa]5[t] + 12*\[Kappa]5[t]^2))/(16*Pi^2), 
 Derivative[1][\[Kappa]5][t] == 
  (Log[10]*(-6*g2[t]^4 + \[Kappa]4[t]^2 + 
     (24*g2[t]^2*(3*Y^2*g1[t]^2 - 5*\[Kappa]5[t]))/5 + 
     (6*\[Kappa]5[t]*(-6*Y^2*g1[t]^2 + 10*\[Kappa]2[t] + 15*\[Kappa]5[t]))/
      5))/(16*Pi^2)}
